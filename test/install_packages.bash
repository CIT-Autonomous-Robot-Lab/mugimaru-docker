...
git clone -b mugimaru-2024 https://github.com/CIT-Autonomous-Robot-Lab/raspicat_description.git
git clone -b mugimaru-2024 https://github.com/CIT-Autonomous-Robot-Lab/raspicat_sim.git
git clone -b master https://github.com/CIT-Autonomous-Robot-Lab/raspimouse2.git
...
git clone -b mugimaru-2024 https://github.com/CIT-Autonomous-Robot-Lab/nmea_navsat_driver.git
git clone -b mugimaru-2024 https://github.com/CIT-Autonomous-Robot-Lab/ros2-ublox-zedf9p.git
cd 
cd 
